...
public class FriendRequestsViewModel extends ViewModel {
    ...
    public void acceptFriendRequest(User user, OnCompleteListener<Object> listener){
        userRepository.acceptFriendRequest(user, listener);
    }
    public void declineFriendRequest(User user, OnCompleteListener<Object> listener){
        userRepository.declineFriendRequest(user, listener);
    }
    public void addFriend(User sender, User recipient, OnCompleteListener<Object> listener){
        userRepository.addFriend(sender, recipient, listener);
    }
